...
//Use:
// given a data array of complex data of size S,
//r = log2(S)
...
void fftr_f(complex_f data[], unsigned log2_N, fft_dir direction)
{
    ...
    if (log2_N > 0)
    {
        ...
        evn = (complex_f*)malloc(Nd2 * sizeof(complex_f));
        odd = (complex_f*)malloc(Nd2 * sizeof(complex_f));
